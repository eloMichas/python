'''
            ...
            jeżeli chcemy zmienić sposób liczenia pozycji to w linijce 13 przy argumencie start wartość zmieniamy na 1,a w linijce 19 i 25 przy modulo zmieniamy 2 na 1)
            w stosunku do tabeli ascii.
'''
def zaszyfrowanie(text):
    list_cipher = []
...
encrypted_text = zaszyfrowanie(text_to_encrypt)
